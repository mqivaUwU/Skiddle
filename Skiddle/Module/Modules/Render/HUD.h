...
public:
        ...
        Module("HUD", "Render", "Display info on the screen", keybind, enabled)
    {
        ...
        registerFloatSetting("R3", "", &r3, 0, 255);
        registerFloatSetting("G3", "", &g3, 0, 255);
        registerFloatSetting("B3", "", &b3, 0, 255);
    ...
    void onEvent(UpdateTickEvent* event) 
    {
        ...
        case 3: // Trans Colors
            ...
            ColorUtil::setClientCustomWaveColor3(0, 0, 255); // Set custom wave color 3 to Blue
            break;
