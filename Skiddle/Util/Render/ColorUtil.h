...
public:
	...
	inline static UIColor setClientCustomColor(float r = 255, float g = 255, float b = 255)
	{
		r1 = UIColor(r, 0, 0);
		g1 = UIColor(0, g, 0);
		b1 = UIColor(0, 0, b);
	...
	inline static UIColor setClientCustomColor2(float r = 255, float g = 255, float b = 255)
	{
		r2 = UIColor(r, 0, 0);
		g2 = UIColor(0, g, 0);
		b2 = UIColor(0, 0, b);
	...
	inline static UIColor setClientCustomWaveColor(float r = 255, float g = 255, float b = 255)
	{
		rgb1 = UIColor(r, g, b);
		return UIColor(r * 255, g * 255, b * 255);
	}
	...
	static void setClientColorType(int type)
	{
		switch (type) {
		case 0:
			rainbow = true;
